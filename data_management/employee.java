...
public class employee {
    ...
    public List<Integer> all_employees(){
        try{
            Connection conn;
    ...
    public int monthly_salary(){
        try{
            ...
            PreparedStatement stmt = conn.prepareStatement("SELECT employee_id, CONCAT(first_name, ' ', last_name) AS name, salary " +
                                        "FROM employee " +
                                        "WHERE vendor_id = ? " +
